...
IOConfig:
	...
	ECIN(ECGETOFFSET("Input", 13, 1), EIN2)
	ECIN(ECGETOFFSET("Input", 13, 1)+1, EIN3)
	ECIN(ECGETOFFSET("Input", 14, 1), EIN4)
	ECIN(ECGETOFFSET("Input", 14, 1)+1, EIN5)
	ECIN(ECGETOFFSET("Input", 16, 1), EIN6)
	ECIN(ECGETOFFSET("Input", 16, 1)+1, EIN7)
	ECIN(ECGETOFFSET("Input", 17, 1), EIN8)
	ECIN(ECGETOFFSET("Input", 17, 1)+1, EIN9)

	ECOUT(ECGETOFFSET("Output", 7, 0), EOUT0)
	ECOUT(ECGETOFFSET("Output", 7, 0)+1, EOUT1)
	ECOUT(ECGETOFFSET("Output", 8, 0), EOUT2)
	ECOUT(ECGETOFFSET("Output", 8, 0)+1, EOUT3)
	ECOUT(ECGETOFFSET("Output", 9, 0), EOUT4)
	ECOUT(ECGETOFFSET("Output", 9, 0)+1, EOUT5)
	ECOUT(ECGETOFFSET("Output", 10, 0), EOUT6)
	ECOUT(ECGETOFFSET("Output", 10, 0)+1, EOUT7)
	ECOUT(ECGETOFFSET("Output", 11, 0), EOUT8)
	ECOUT(ECGETOFFSET("Output", 11, 0)+1, EOUT9)
...
GLOBAL INT EIN0, EIN1, EIN2, EIN3, EIN4, EIN5, EIN6, EIN7, EIN8, EIN9 

GLOBAL INT EOUT0, EOUT1, EOUT2, EOUT3, EOUT4, EOUT5, EOUT6, EOUT7, EOUT8, EOUT9 
